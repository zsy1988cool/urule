...
public class CrosstabEditorServletHandler extends RenderPageServletHandler {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (method != null) {
            ...
            var4.put("contextPath", req.getContextPath());
            ...
            String var5 = req.getParameter("file");
            ...
            PrintWriter var8 = resp.getWriter();
    ...
    private String a(XSSFCell var1) {
        String var2 = null;
        CellType cellType = var1.getCellTypeEnum();
        switch(cellType.getCode()) {
            ...
            case 2:
                ...
                break;
            case 3:
                var2 = String.valueOf(var1.getNumericCellValue());
            case 4:
            case 5:
            case 6:
            case 7:
