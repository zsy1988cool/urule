    ...
    URule.CrossTable.prototype={
        ...
        toXml:function(){
            ...
            let xml = '<?xml version="1.0" encoding="utf-8"?>\n' +
                '\n' +
                '<crosstab salience="10" expires-date="2020-12-12 12:00:00" assign-target-type="variable" var-category="客户" var="level" var-label="等级" datatype="Integer">\n' +
                '  <remark><![CDATA[交叉]]></remark>\n' +
                '  <header rowspan="1" colspan="1"><![CDATA[LEFT && TOP]]></header>\n' +
                '  <import-variable-library path="jcr:/保险业务/保险相关对象.vl.xml"/>\n' +
                '  <import-constant-library path="jcr:/保险业务/保险常用常量.cl.xml"/>\n' +
                '  <import-action-library path="jcr:/保险业务/业务动态操作.al.xml"/>\n' +
                '  <row number="1" type="top" bundle-data-type="variable" var-category="客户" var="car" var-label="是否有车" datatype="Boolean"/>\n' +
                '  <row number="2" type="left"/>\n' +
                '  <row number="3" type="left"/>\n' +
                '  <column number="1" type="left" bundle-data-type="variable" var-category="客户" var="age" var-label="年龄" datatype="Integer"/>\n' +
                '  <column number="2" type="top"/>\n' +
                '  <column number="3" type="top"/>\n' +
                '  <condition-cell row="1" col="2" rowspan="1" colspan="1">\n' +
                '    <joint type="and">\n' +
                '      <condition op="Equals">\n' +
                ...
                '    </joint>\n' +
                '  </condition-cell>\n' +
                '  <condition-cell row="2" col="1" rowspan="1" colspan="1">\n' +
                '    <joint type="and">\n' +
                '      <condition op="LessThen">\n' +
                '        <value content="20" type="Input"/>\n' +
                '      </condition>\n' +
                '    </joint>\n' +
                '  </condition-cell>\n' +
                '  <value-cell row="2" col="2">\n' +
                ...
                '  </value-cell>\n' +
                '  <condition-cell row="1" col="3" rowspan="1" colspan="1">\n' +
                '    <joint type="and">\n' +
                '      <condition op="Equals">\n' +
